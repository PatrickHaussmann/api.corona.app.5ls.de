...
module.exports = async (req, res) => {
  ...
  parsedData.forEach((element) => {
    ...
    result.countries[key] = {
      ...
      total_cases_per_million: parseFloat(element["total_cases_per_million"]),
      ...
      total_deaths_per_million: parseFloat(element["total_deaths_per_million"]),
      new_deaths_per_million: parseFloat(element["new_deaths_per_million"]),
    ...
    if (
      ...
      result.countries[key].deathRate =
        result.countries[key].total_deaths / result.countries[key].total_cases;
  });
